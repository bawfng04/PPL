...
"""
        expect = Program([FuncDecl("votien",[],VoidType(),Block([If(IntLiteral(1), Block([Return(None)]), None, None)]))
		])
        self.assertTrue(TestAST.test(input, str(expect), inspect.stack()[0].function))
...
"""
        expect = Program([FuncDecl("votien",[],VoidType(),Block([If(IntLiteral(1), Block([Assign(Id("a"),IntLiteral(1))]), None, Block([Assign(Id("a"),IntLiteral(1))]))]))
		])
        self.assertTrue(TestAST.test(input, str(expect), inspect.stack()[0].function))
...
"""
        expect = Program([FuncDecl("votien",[],VoidType(),Block([If(IntLiteral(1), Block([Return(None)]), [(IntLiteral(1),Block([Assign(Id("a"),IntLiteral(1))])), (IntLiteral(2),Block([Assign(Id("a"),IntLiteral(1))]))], None)]))
		])
        self.assertTrue(TestAST.test(input, str(expect), inspect.stack()[0].function))
...
"""
        expect = Program([FuncDecl("foo",[],VoidType(),Block([If(IntLiteral(1), Block([Return(None)]), None, None),If(BinaryOp("+", IntLiteral(1), IntLiteral(1)), Block([Return(IntLiteral(1)),Return(None)]), None, None)]))
		])
        self.assertTrue(TestAST.test(input, str(expect), inspect.stack()[0].function))
...
"""
        expect = Program([FuncDecl("foo",[],VoidType(),Block([If(IntLiteral(1), Block([Return(None)]), [(IntLiteral(1),Block([Return(IntLiteral(1)),Return(None)]))], Block([Return(None)])),If(IntLiteral(1), Block([Return(None)]), None, Block([Return(IntLiteral(1)),Return(None)]))]))
		])
        self.assertTrue(TestAST.test(input, str(expect), inspect.stack()[0].function))
...
"""
        expect = Program([FuncDecl("foo",[],VoidType(),Block([If(IntLiteral(1), Block([Return(IntLiteral(1))]), [(IntLiteral(2),Block([Return(IntLiteral(2))])), (IntLiteral(3),Block([Return(IntLiteral(3))])), (IntLiteral(4),Block([Return(IntLiteral(4))]))], None)]))
		])
        self.assertTrue(TestAST.test(input, str(expect), inspect.stack()[0].function))
